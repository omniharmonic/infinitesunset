...
- Nine Chromium browser tests exercise real WebGPU and WebGL 2, settings persistence and URL restoration, pointer/touch input, hidden interface recovery with a keyboard and touchscreen, pause/fullscreen/PNG export, camera denial and recovery, local models running on synthetic video, track release, and reduced motion.
